# cloud-itonami-iso3166-irl

Open ISO 3166 Blueprint for **IRL**: Ireland.
...
tax registration, and local-content rules in Ireland, so the operator
...
- **Not the government of Ireland.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Irish-licensed counsel
...
(ISO 3166 `IRL`). Required capabilities:
